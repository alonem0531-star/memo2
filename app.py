...
# これらは input() や print() を使わない純粋なデータ処理の関数です
from memo_logic import (
    make_memo,
    sort_memos_by_date,
    parse_memo_number,
    delete_memo,
...
def show_help():
    """各機能の簡単な説明を表示する関数"""
    print("\n=== ヘルプ ===")
    print("1. メモを追加   ─ テキストを入力して保存します")
    print("2. 一覧を表示   ─ 保存中のメモを番号付きで表示します")
    print("3. メモを削除   ─ 番号を指定して1件削除します")
    print("4. 全メモ削除   ─ すべてのメモを削除します")
    print("5. メモを検索   ─ キーワードを含むメモだけ表示します")
    print("6. メモを編集   ─ 番号を指定して内容を書き換えます")
    print("7. 終了         ─ アプリを終了します")
    print("==============\n")
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            # 1〜8以外が入力された場合
            print("無効な選択です。1から8のいずれかを入力してください。")
